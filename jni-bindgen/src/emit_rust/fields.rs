...
impl<'a> Field<'a> {
    ...
    pub fn emit(
        ...
        let (rust_set_type, rust_get_type) = match descriptor {
            ...
            field::Descriptor::Single(field::BasicType::Char) => {
                ("__jni_bindgen::jchar", "__jni_bindgen::jchar")
            }
